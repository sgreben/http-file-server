...
```sh
# Linux
curl -L https://github.com/sgreben/http-file-server/releases/download/1.4.0/http-file-server_1.4.0_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/sgreben/http-file-server/releases/download/1.4.0/http-file-server_1.4.0_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/sgreben/http-file-server/releases/download/1.4.0/http-file-server_1.4.0_windows_x86_64.zip
unzip http-file-server_1.4.0_windows_x86_64.zip
```
